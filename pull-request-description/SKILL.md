...
2. **Write the Description**
   - Write the description that consist of:
     ...
     - What's changed : contains list of changes according to the committed message.
       Don't list each file changes, just summarize them. Write clear, concise, and developer-friendly sentences under 160 characters of each item.
